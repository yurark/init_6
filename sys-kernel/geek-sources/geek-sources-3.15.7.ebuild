...
CK_VER="3.15-ck1"
FEDORA_VER="f20"
GRSEC_VER="3.0-${KSV}-201407282112-2" # 07/07/14 20:47
...
SUPPORTED_USES="aufs bfq brand -build ck deblob exfat fedora gentoo grsec ice lqx mageia openwrt openelec optimize pax pf reiser4 suse symlink uksm zfs"
