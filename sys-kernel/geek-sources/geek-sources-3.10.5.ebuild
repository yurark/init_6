...
user_fedora_ver="f19"
#user_gentoo_ver="$KMV"
user_grsec_ver="3.10.5"
#user_ice_ver="$KMV"
user_lqx_ver="3.10.5-1"
user_lqx_src="http://liquorix.net/sources/${user_lqx_ver}.patch.gz"
user_mageia_ver="releases/3.10.5/3.mga4"
user_pax_ver="3.10.5-test8"
user_pf_ver="3.10.1-pf"
user_reiser4_ver="3.10"
user_rt_ver="3.10.4-rt1"
...
SUPPORTED_USES="aufs bfq branding -build ck fedora gentoo grsec ice lqx mageia pax pf reiser4 rt suse symlink uksm zen zfs"
