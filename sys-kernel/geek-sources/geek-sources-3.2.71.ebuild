...
#GRSEC_VER="3.1-${KSV}-201509201147" # 20/09/15 11:47
ICE_VER="for-linux-3.2.71-2015-08-22"
LQX_VER="${KMV}.28-1"
...
SUPPORTED_USES="aufs bfq brand -build ck deblob fedora gentoo hardened ice lqx mageia pf rsbac suse symlink uksm"
