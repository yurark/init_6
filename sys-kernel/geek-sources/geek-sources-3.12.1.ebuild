...
MAGEIA_VER="releases/3.12.0/3.mga4"
OPTIMIZATION_VER="1"
PAX_VER="3.12.1-test1"
...
SUPPORTED_USES="aufs bfq bld brand -build ck -deblob exfat fedora gentoo ice mageia optimization pax pf rt suse symlink uksm zen zfs"
