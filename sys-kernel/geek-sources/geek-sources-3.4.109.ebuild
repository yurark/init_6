...
ICE_VER="for-linux-${KMV}.109-2015-09-23"
MAGEIA_VER="releases/${KMV}.6/1.mga3"
PAX_VER="${KMV}.8-test32"
...
SUPPORTED_USES="aufs bfq bld brand -build ck deblob fedora gentoo ice mageia pax pf suse symlink uksm zen"
