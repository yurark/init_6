...
PATCHES=(
	"${FILESDIR}/${P}-do-not-cleanup-routes.patch"
	"${FILESDIR}/${P}-disable-wispr.patch"
	"${FILESDIR}/${P}-init-nat-after-tethering.patch"
	"${FILESDIR}/${P}-do-not-add-default-gw-as-timeserver.patch"
	"${FILESDIR}/${P}-ipv6-disabled-by-default.patch"
)
