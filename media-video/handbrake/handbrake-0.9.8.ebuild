...
SRC_URI="http://iweb.dl.sourceforge.net/project/handbrake/${PV}/${MY_P}.tar.bz2
	...
	${SRC_CONTRIB}freetype-2.4.7.tar.bz2 -> freetype-2.4.7-${P}.tar.bz2
	${SRC_CONTRIB}fribidi-0.19.2.tar.gz -> fribidi-0.19.2-${P}.tar.gz
	${SRC_CONTRIB}lame-3.98.tar.gz -> lame-3.98-${P}.tar.gz
	${SRC_CONTRIB}libass-0.10.0-1.tar.gz -> libass-0.10.0-1-${P}.tar.gz
	...
	${SRC_CONTRIB}libmkv-0.6.5-0-g82075ae.tar.gz -> libmkv-0.6.5-0-g82075ae-${P}.tar.gz
	${SRC_CONTRIB}libogg-1.3.0.tar.gz -> libogg-1.3.0-${P}.tar.gz
	...
	${SRC_CONTRIB}libvorbis-aotuv_b6.03.tar.bz2 -> libvorbis-aotuv_b6.03-${P}.tar.bz2
