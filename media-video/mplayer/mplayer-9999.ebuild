...
joystick +jpeg kernel_linux ladspa libcaca lirc +live lzo +mad +md5sum
+mmx mmxext mng +mp2 +mp3 musepack nas +nemesi +network openal +opengl oss
+png +pnm pulseaudio -pvr +quicktime radio +rar +real -realcodecs +rtc
-samba +schroedinger +sdl +speex sse sse2 ssse3 svga teletext tga +theora
+tremor +truetype +unicode v4l v4l2 vdpau vidix +vorbis -win32codecs +X +x264
