...
# https://github.com/init6/init_6/blob/master/eclass/geek-uek.eclass
# Bugs: https://github.com/init6/init_6/issues
# Wiki: https://github.com/init6/init_6/wiki/geek-sources

case ${EAPI} in
	5)	: ;;
	*)	die "geek-uek.eclass: unsupported EAPI=${EAPI:-0}" ;;
esac

if [[ ${___ECLASS_ONCE_GEEK_UEK} != "recur -_+^+_- spank" ]]; then
___ECLASS_ONCE_GEEK_UEK="recur -_+^+_- spank"
