...
zen_init_variables() {
	...
	: ${ZEN_SRC:=${ZEN_SRC:-"https://github.com/zen-kernel/zen-kernel/compare/torvalds:v${ZEN_VER/KMV/$KMV}...${ZEN_VER/KMV/$KMV}/master.diff"}} # Patchset sources url
	: ${ZEN_URL:=${ZEN_URL:-"https://github.com/zen-kernel/zen-kernel"}} # Patchset url
